...
function SidebarProvider({
  ...
  // Nous ajoutons un état pour que nous puissions faire data-state="expanded" ou "collapsed".
...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Ceci gère l'espace de la barre latérale sur bureau */}
      <div
      ...
      <div
        ...
        className={cn(
          ...
          // Ajuster le padding pour les variantes flottantes et insérées.
          variant === "floating" || variant === "inset"
...
function SidebarMenuSkeleton({
  ...
  // Largeur aléatoire entre 50 à 90%.
